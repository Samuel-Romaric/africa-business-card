...
@section('title', 'Entreprise - Modifier offre | ')
    ...
    <div class="container-fluid mt-5"> 
        <div class="row">
            <div class="col-sm-6">
                ...
                <h5 class="mb-0">Modifer produit de {{ $business->nom_commercial }}</h5>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        {{-- @include('layouts.partials.flash-message') --}}
            ...
            <div class="card" style="width: 100%; padding: 2%;">
                ...
                <form method="POST" action="{{ route('admin.business.offer.update', ['item_id' => $business->id, 'slug' => $business->slug]) }}" enctype="multipart/form-data" id="updateOfferForm">
                    <!--begin::Body-->
                    <div class="card-body">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="card px-2 py-2">
                                    <img class="" src="{{ $offer->getCoverOfferFullUrl() }}" style="height: 160px; width: 250px;" alt="">
                                </div>
                                {{-- <img class="" src="{{ $offer->getCoverOfferFullUrl() }}" style="height: 160px; width: 250px; border: 1px solid #d5d3d3; border-radius: 5px;" alt=""> --}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="titre" value="{{ $offer->titre }}" required class="form-control" id="title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="coverOffer" class="form-label">Nouvelle image de couverture</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="type" required id="type">
                                                ...
                                                <option value="produit" {{ $offer->type == 'produit' ? 'selected' : '' }}>Produit</option>
                                                <option value="service" {{ $offer->type == 'service' ? 'selected' : ''}}>Service</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="price" value="{{ $offer->price }}" required class="form-control" id="price" aria-label="Amount (to the nearest franc cfa)">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control" id="description" cols="30" rows="5" placeholder="Ici votre description de l'offre...">{{ $offer->description }}</textarea>
                                </div>
                            </div>
                        </div>
